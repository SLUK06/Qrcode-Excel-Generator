...
label_pasta_excel = Label(janela, text="Pasta do Excel:", bg="#D31145", fg="#FFFFFF", font=("KelloggsSansMedium", 15,"bold"))
label_pasta_excel.pack(pady=(10,0))
entry_pasta_excel = Entry(janela)
entry_pasta_excel.pack()
button_selecionar_pasta_excel = Button(janela, text="Selecionar Pasta", font=("KelloggsSansMedium", 10,"bold"), command=selecionar_pasta_excel)
button_selecionar_pasta_excel.pack(pady=5)

label_nome_planilha = Label(janela, text="Nome da Planilha:", bg="#D31145", fg="#FFFFFF", font=("KelloggsSansMedium", 15,"bold"))
label_nome_planilha.pack(pady=(20,0))
entry_nome_planilha = Entry(janela)
entry_nome_planilha.pack()

label_nome_coluna_link = Label(janela, text="Coluna do Link:", bg="#D31145", fg="#FFFFFF", font=("KelloggsSansMedium", 15,"bold"))
label_nome_coluna_link.pack(pady=(20,0))
entry_nome_coluna_link = Entry(janela)
entry_nome_coluna_link.pack()

label_nome_coluna_texto = Label(janela, text="Coluna do Texto:", bg="#D31145", fg="#FFFFFF", font=("KelloggsSansMedium", 15,"bold"))
label_nome_coluna_texto.pack(pady=(20,0))
entry_nome_coluna_texto = Entry(janela)
entry_nome_coluna_texto.pack()

label_pasta_destino = Label(janela, text="Pasta de Destino:", bg="#D31145", fg="#FFFFFF", font=("KelloggsSansMedium", 15,"bold"))
label_pasta_destino.pack(pady=(20,0))
entry_pasta_destino = Entry(janela)
entry_pasta_destino.pack()
button_selecionar_pasta_destino = Button(janela, text="Selecionar Pasta", font=("KelloggsSansMedium", 10,"bold"), command=selecionar_pasta_destino)
button_selecionar_pasta_destino.pack(pady=5)

button_gerar_qrcode = Button(janela, text="Gerar QR Codes", font=("KelloggsSansMedium", 10,"bold"), command=gerar_qrcode, width=20)
button_gerar_qrcode.pack(pady=(30,10))

label_assinatura = Label(janela, text="Desenvolvido por: SLUK06", bg="#D31145", fg="#FFFFFF", font=("KelloggsSansMedium", 9,"bold"))
